<div class="max-w-3xl max-auto p-6">
    <div class="mb-6">
        <flux:button href="{{ route('posts') }}" wire:navigate icon="arrow-left" valiant="subtle">
            一覧に戻る
        </flux:button>
    </div>
    <div class="mb-8 border-b border-zinc-200 pb-6 dark:border-zinc-700">
        ...
        <div class="flex item-center text-sm text-gray-500 gap-4 mb-2">
